...
import RadioForm from 'react-native-simple-radio-button'; //npm i react-native-simple-radio-button
...
export default function App() {
  ...
  function calculate() {
    let result = 0;
    if (gender === 'male') {
      result = (879 + 10.2 * weight) * intensity; //for male
    } else {
      result = (795 + 7.18 * weight) * intensity; //for female
    }
    setCalories(result);
  }
